...
import com.exory550.exorynotes.databinding.ActivityViewImageBinding
...
import com.exory550.exorynotes.recyclerview.adapter.ImageAdapter
...
class ViewImage : AppCompatActivity() {
    ...
    private fun saveToDevice(image: Image) {
        ...
        if (file != null && file.exists()) {
            ...
            intent.putExtra(Intent.EXTRA_TITLE, "ExoryNotes Image")
