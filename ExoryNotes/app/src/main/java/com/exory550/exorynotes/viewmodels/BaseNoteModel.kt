...
import com.exory550.exorynotes.ActionMode
...
import com.exory550.exorynotes.legacy.Migrations
import com.exory550.exorynotes.legacy.XMLUtils
...
import com.exory550.exorynotes.preferences.ListInfo
import com.exory550.exorynotes.preferences.Preferences
import com.exory550.exorynotes.preferences.SeekbarInfo
...
import com.exory550.exorynotes.room.livedata.Content
import com.exory550.exorynotes.room.livedata.SearchResult
...
class BaseNoteModel(private val app: Application) : AndroidViewModel(app) {
    ...
    private fun importZipBackup(uri: Uri) {
        ...
        viewModelScope.launch(exceptionHandler) {
            ...
            withContext(Dispatchers.IO) {
                ...
                val databaseEntry = zipFile.getEntry(ExoryNotesDatabase.DatabaseName)

                val databaseFile = File(backupDir, ExoryNotesDatabase.DatabaseName)
    ...
    private fun executeAsyncWithCallback(function: suspend () -> Unit, onComplete: (success: Boolean) -> Unit) {
