...
import com.exory550.exorynotes.activities.ConfigureWidget
import com.exory550.exorynotes.activities.MakeList
import com.exory550.exorynotes.activities.TakeNote
...
class WidgetProvider : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (intent.action) {
            ...
            ACTION_CHECKED_CHANGED -> {
                ...
                val database = ExoryNotesDatabase.getDatabase(context.applicationContext as Application)
    ...
    companion object {
        ...
        private const val EXTRA_MODIFIED_NOTES = "com.exory550.exorynotes.EXTRA_MODIFIED_NOTES"
        private const val ACTION_NOTES_MODIFIED = "com.exory550.exorynotes.ACTION_NOTE_MODIFIED"

        const val ACTION_OPEN_NOTE = "com.exory550.exorynotes.ACTION_OPEN_NOTE"
        const val ACTION_OPEN_LIST = "com.exory550.exorynotes.ACTION_OPEN_LIST"

        const val ACTION_CHECKED_CHANGED = "com.exory550.exorynotes.ACTION_CHECKED_CHANGED"
        const val EXTRA_POSITION = "com.exory550.exorynotes.EXTRA_POSITION"
    }
}
